...
# closure and is intentionally not pruned here (see the top-level README
# note; `make clean` removes stale classes from it). Each profile's own
# def/XXX, like its json/XXX, holds only that profile's own classes and is
# pruned the same way json/ is.
