...
Some VariantPathogenicityProposition attributes are inherited from :ref:`GeneticContextVariantProposition`.
...
**Used in:** :ref:`VariantPathogenicityEvidenceLine`, :ref:`VariantPathogenicityStatement`
